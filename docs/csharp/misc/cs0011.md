...
未能解析程序集“assembly”中由类型“type”引用的基类或接口“class”  
 ...
 有关详细信息，请参阅) 的 " [添加引用" 对话框](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager) 和 [**引用** (c # 编译器选项](../language-reference/compiler-options/inputs.md#references)。  
